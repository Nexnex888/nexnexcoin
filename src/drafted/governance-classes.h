 ...
 *
 *   // network
 *   CNexnexcoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.nexnexcoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CNexnexcoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CNexnexcoinNetwork(UniValue objIn)
    {
...
// // can be under: NexnexcoinNetwork
// //   -- signature requirements : Key1(User)
// class CNexnexcoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == NexnexcoinNetwork);
//     // }
