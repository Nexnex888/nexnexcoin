...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "NexnexcoinNetwork") type = NexnexcoinNetwork;
    if(strType == "NexnexcoinNetworkVariable") type = NexnexcoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == NexnexcoinNetwork) s = "NexnexcoinNetwork";
    if(type == NexnexcoinNetworkVariable) s = "NexnexcoinNetworkVariable";
