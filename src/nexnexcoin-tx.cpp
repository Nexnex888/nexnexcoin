...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Nexnexcoin Core nexnexcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  nexnexcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nexnexcoin transaction") + "\n" +
              "  nexnexcoin-tx [options] -create [commands]   " + _("Create hex-encoded nexnexcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nexnexcoin transaction
