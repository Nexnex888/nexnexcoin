...
#define BOOST_TEST_MODULE Nexnexcoin Test Suite

#include "test_nexnexcoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_nexnexcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
