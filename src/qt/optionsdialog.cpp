    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("NXNXASH-light"), QVariant("light"));
    ui->theme->addItem(QString("NXNXASH-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("NXNXASH-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("NXNXASH-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("NXNXASH-traditional"), QVariant("trad"));
