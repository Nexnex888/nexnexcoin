    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Nexnexcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Nexnexcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nexnexcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Nexnexcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Nexnexcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Nexnexcoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nexnexcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nexnexcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a nexnexcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Nexnexcoin Core help message to get a list with possible Nexnexcoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Nexnexcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nexnexcoin network", "", count));
    } else {
...
{
    QString strTitle = tr("Nexnexcoin Core"); // default title
    ...
    // Append title to "Nexnexcoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
