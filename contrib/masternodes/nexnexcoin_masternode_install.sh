...
COIN_NAME='Nexnexcoin'
coin_name="nexnexcoin"
COIN_DATA="nexnexcoincore"
COIN_PORT=4244
COIN_RPCPORT=4243
...
COIN_TGZ="https://github.com/nexnexcoin-official/nexnexcoin/releases/download/v1.0.0.1/nexnexcoincore-1.0.0-linux${KERN_ARCH}.tar.gz"
...
function install_sentinel() {
  ...
  local SENTINEL_PATH="sentinel-nexnexcoin"
  cd $CONFIGHOME
  git clone https://github.com/nexnexcoin-official/sentinel.git $SENTINEL_PATH
  cd $SENTINEL_PATH
