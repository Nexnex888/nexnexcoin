...
This mechanism has been integrated into Bitcore-Node-Nexnexcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/nexnexcoin-official/insight-api-nexnexcoin#web-socket-api](https://github.com/nexnexcoin-official/insight-api-nexnexcoin#web-socket-api)
* API: [https://github.com/nexnexcoin-official/insight-api-nexnexcoin#instantsend-transactions](https://github.com/nexnexcoin-official/insight-api-nexnexcoin#instantsend-transactions)
...
By default, the Nexnexcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Nexnexcoin Core daemon:
