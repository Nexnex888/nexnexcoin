...
Only requiring some minor changes is nexnexcoin.cpp.
...
Changes to nexnexcoin.cpp
----------------------
nexnexcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
