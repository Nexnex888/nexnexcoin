...
Nexnexcoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 4244.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 4243 for connections and services them.
...
However, in open source software such as Nexnexcoin Core, where everyone uses
...
pay attention to for reviewers of Nexnexcoin Core code.

General Nexnexcoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Nexnexcoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
